...
function toRef(recordId: string): PrecedentRef {
  ...
  return { finding, effectiveStatus: finding.findingStatus, score: 10, matchedFactualIngredients: [], matchedByCategory: { transactionTypes: [], actorRoles: [], allegedConduct: [], evidenceTypes: [] }, additionalPrecedentFactsNotMatched: [] };
}
