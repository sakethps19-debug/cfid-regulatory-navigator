...
// Moved under /admin (application-wide demo-readiness sprint): this is a
// corpus-management register — which verified CFID orders have and have
// not yet been turned into structured findings, plus the residual
// exclusion/pending-link list — not a research task for a regular officer.
// The old top-level route now redirects here (see
// src/app/(app)/awaiting-analysis/page.tsx) so existing bookmarks/links
// keep working.
export default async function AdminAwaitingAnalysisPage() {
