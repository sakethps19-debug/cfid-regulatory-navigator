...
export function AnalyzerLanding({ provisions }: { provisions: LegalProvision[] }) {
  ...
  return <FixedScenarioAnalyzer provisions={provisions} onSwitchToFreeForm={() => setMode("freeform")} />;
}
